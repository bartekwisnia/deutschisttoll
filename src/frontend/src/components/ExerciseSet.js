...
function MapExerciseSet(results, model_config) {
  let elements = [];
...
class ExerciseSetList extends React.Component{

  constructor(props){
    super(props);
    this.state = {
      endpoint: "api/exercise-set/",
      placeholder: "Ładuje...",
      model_config: [],
      config_loaded: false,
    };
  ...
  render(){
    // console.log("render exercise set site");
          ...
          return      <div className="column is-4 is-offset-2">
                         <div className="level">
                             <div className="level-item has-text-centered">
                                 <a className="button is-info" onClick={() => this.props.selectSite(1, 0)} >Nowy zestaw</a>
                             </div>
                         </div>
...
componentDidMount() {
  ...
  render() {
    // console.log("render exercise set form");
    ...
    <React.Fragment>
      <nav className="breadcrumb" aria-label="breadcrumbs">
        <ul>
          <li><a onClick={this.props.endEdit}>Zestawy ćwiczeń</a></li>
...
class ExerciseSetPreview extends React.Component {
  static propTypes = {
    endpoint: PropTypes.string.isRequired
  };
...
class ExerciseSetPlay extends React.Component {
  static propTypes = {
    endpoint: PropTypes.string.isRequired
  };
...
render() {
  ...
  console.log("render exercise set play");
  console.log(data);
    ...
    <React.Fragment>
          <div className="box">
            ...
            {finished && <div className="level">
                          <div className="level-item">
                            <a className="button" onClick={this.handleRestart}>Powtórz zestaw</a>
...
class ExerciseSetFrontpage extends React.Component {
  static propTypes = {
    endpoint: PropTypes.string.isRequired
  };
...
export {
  ExerciseSet, ExerciseSetForm, ExerciseSetPreview, MapExerciseSet, ExerciseSetList,
}
